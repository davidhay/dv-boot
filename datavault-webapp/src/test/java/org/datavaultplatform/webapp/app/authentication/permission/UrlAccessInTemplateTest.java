...
public class UrlAccessInTemplateTest {
   ...
   * These should result in calls to 3 and 4 arg version of PermissionEvaluator bean's hasPermission
   * methods. Spring adds Authentication as first arg in both hasPermission method calls.
   */
  @Controller
